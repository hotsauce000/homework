...
//		NOT (v2 = true)
		Predicate NOT1 = new NOT(p3);
//		(v1 = 0 AND NOT (v2 = true))
		Predicate AND1 = new AND(p2 , NOT1);
//		(v3 = "Running" OR (v2 == true)
		Predicate OR1 = new OR(p4 , p3);
//		((v1 = 0 AND NOT (v2 = true)) OR (v3 = "Running" OR (v2 == true))
		p1 = new OR(AND1 , OR1);
